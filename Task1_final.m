...
for i = 1:numel(imageFiles)
    ...
    % Step 1: Convert the image to the CIE Lab color space
    labImg = rgb2lab(img);

    % Step 2: Extract the a* and b* channels
    aChannel = labImg(:, :, 2);
    bChannel = labImg(:, :, 3);

    % Step 3: Skin color segmentation based on a* and b* channels
    skinMask = (aChannel > 5 & aChannel < 25) & (bChannel > 10 & bChannel < 40);
